...
# Loesung: Foto + Gradient als EIN Bild rendern (Headless-Chrome-Screenshot) -> Canva zeigt es korrekt.
#
# Einmal laufen lassen, nachdem du photo.jpg getauscht hast:
#   python3 bake_photo.py   ->  erzeugt cover_bg.png und close_bg.png
...
# Gleicher Chrome-Pfad wie in build.py — bei Bedarf anpassen (siehe Kommentar dort).

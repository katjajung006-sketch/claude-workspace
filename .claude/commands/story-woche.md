...
- **Frame 1 trägt meist einen niedrigschwelligen Sticker** (Emoji-Slider — niedrigste Hürde für die müde Frau; zählt NICHT als Poll, gibt laut Research direkt auf Frame 1 einen Algo-Schub). Aber **nicht zwingend jeden Tag, sonst wird die Woche vorhersehbar:** Tage, die ihre Interaktion schon woanders tragen (Frage-Box, Umfrage, Funnel-CTA) oder einen stillen Moment brauchen (Leiser Take, BTS), dürfen Frame 1 **sticker-frei** lassen. Pro Woche eine gesunde Mischung aus Slider-Tagen und stillen Frame-1-Tagen — jeder Tag braucht aber irgendwo genau eine klare Interaktion.

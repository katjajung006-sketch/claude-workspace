# Reel Spiegel — Text im Video

> Vollständiges Content-Piece für minimalistische Spiegel-Reels: ruhiges Video, der Text trägt alles. Ziel: sofortige Wiedererkennung bei Frauen 40+ — „Das bin ich." Kalter Traffic, Problem-Bewusstsein, Hauptziel Speichern/Teilen/Folgen. Contentsäule: Der Körper im Funktionsmodus.
...
**Wenn $ARGUMENTS leer:** Claude wählt selbst einen Winkel aus dem Erfahrungsraum der Zielgruppe (siehe Pool unten).
**Mit Thema:** Den genannten Winkel verwenden.

### Winkel-Pool (variieren, nicht wiederholen)
- Anzeichen, dass du im Funktionsmodus lebst
- Was passiert, wenn du dich jahrelang selbst übergehst
- Sätze, die du dir sagst, ohne sie zu hinterfragen
- Woran dein Körper merkt, dass du nicht mehr bei dir bist
- Momente, in denen du überall bist — nur nicht bei dir
- Warum Ruhe sich für dich ungewohnt anfühlt
- Der Unterschied zwischen müde und erschöpft vom Funktionieren

---

## Was dieses Format tut

Es erklärt kein Yoga. Es macht den Moment sichtbar, in dem sie merkt: *Ich funktioniere nicht einfach nur — ich bin schon lange nicht mehr richtig bei mir.*

Sie muss dich nicht kennen. Sie muss Yoga nicht kennen. Sie muss nur denken: „Das bin ich."

Im Video passiert wenig — der Text trägt alles. Das Video sagt: *Hier musst du nichts beweisen. Hier darfst du kurz ankommen.*

**Bewusstseinsstufe:** Problem-Bewusstsein. Sie weiß nur: müde, angespannt, ständig im Kopf, funktioniert, spürt sich kaum. Hol sie genau dort ab — nicht mit einer Lösung, sondern mit einem Spiegel.

---

## Output 1 — Text im Video

**Länge:** 7–12 Sekunden lesbar. Kurz genug für hohe Completion, tief genug für Wiedererkennung.
...
> Du merkst erst abends, dass du den ganzen Tag nicht richtig geatmet hast.
> Du kannst schlecht sagen, was du brauchst.
...
Kurz, klar, scrollstoppend. Das Bild, das im Feed und auf dem Profil neugierig macht.

**Regeln:**
- Maximal 3–5 Wörter, eine Zeile.
- Trifft den Zustand, nicht die Lösung.
- Anders als der Hook-Titel im Video.

Beispiele:
> Dein Körper merkt es zuerst
> Das ist kein normaler Stress
...
Genau **5 Hashtags**, präzise — keine generischen Mega-Tags wie #yoga oder #selfcare. Mischung aus Zustand und Zielgruppe, auf den Winkel zugeschnitten.

Beispiele: #funktionsmodus · #frauenab40 · #yogafüranfängerinnen · #zurückzudir · #körperwahrnehmung
...
Filmen: [kurze Szenen-Idee]

---
THUMBNAIL-HOOK (Reelcover)

[3–5 Wörter, scrollstoppend]
...
Nach der Ausgabe: kurz fragen, ob Hook, Liste, Schlusssatz oder Caption angepasst werden sollen — oder ob ein neuer Winkel gewünscht ist.

---

## Stilregeln

- Ziel ist stille Erkenntnis — kein Coaching, keine Analyse, keine Motivation, kein „Mach diese Übung und alles ist gut".
- Leise Autorität mit gezielter Kante — die Kante richtet sich gegen das System des Funktionierens, nie gegen die Frau.
- Nie: „Du musst endlich etwas ändern." Stattdessen: „Du hast lange gelernt, über dich hinwegzugehen. Dein Körper hat nur irgendwann aufgehört, das still mitzumachen."
- Kurze Sätze. Alltagssprache. Wenig Fachbegriffe. Keine langen Erklärungen.
- Nicht spirituell überladen, nicht sportlich, nicht optimierend, kein Yoga-Guru-Ton.
- Yoga als Rückweg — nicht als weiteres To-do.
- Brand Voice aus `brand-voice.md` strikt einhalten.
- Verbotene Wörter: Selbstoptimierung · Disziplin · Challenge · Transformation · Hustle · High Performance · Glow up.

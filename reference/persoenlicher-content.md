...
Festgelegt mit Katja 2026-06-13: **persönlich an allen 7 Story-Tagen + 1× pro Woche im Feed.**

### Stories — jeden Tag ein persönlicher Moment
Persönliches lebt in den Stories (verschwindet nach 24 h → niedriger Druck, ideal für die Hermit-Linie). Jeder Tag trägt einen kleinen Moment — meist 1 Frame, oft ein einziger ehrlicher Satz. Über die Woche kommen **alle 6 Türen** dran:
- **Mo, Di, Mi, Do, Sa** → je eine der **5 Alltags-Türen (1, 2, 3, 4, 6)**, Tag-Zuordnung rotiert wöchentlich (alle 5 jede Woche).
- **Fr (Freebie) + So (Telegram)** → **Tür 5 (Das Warum / deine Geschichte)** als persönlicher Einstieg, der in den Funnel überleitet (erster Frame der Einladung). Tagesziel bleibt der CTA.

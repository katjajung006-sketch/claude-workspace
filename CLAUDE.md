...
- **Flows (Stand 2026-06-23):**
  ...
  - **Offen für den 28.06. (Pro-Setup):** für RESET + NACHTRUHE den echten Trigger-Reel zuweisen (bisher Platzhalter-Beitrag, weil die Reels noch nicht gepostet sind) → dann **Set Live**; **7ZEICHEN auf „any post" stellen + Live**; bei allen die öffentliche Kommentar-Antwort von Englisch („Check your inbox, link sent") auf Deutsch umstellen (im Free-Plan nicht editierbar). „any post" ist die Pro-Funktion, mit der ein Keyword über ALLE (auch künftige) Beiträge lauscht — darum die distinktiven Keywords (7ZEICHEN/3MINUTEN/RESET/NACHTRUHE), CHECK bleibt post-gebunden.

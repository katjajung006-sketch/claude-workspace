...
- **Flows (Stand 2026-06-23):**
  ...
  - **STATUS 2026-06-29 — alles live geschaltet:** Auf **Instagram** sind alle 4 Quick-Automations **LIVE auf „any post"** mit deutschen öffentlichen Antworten (7ZEICHEN · 3MINUTEN · RESET · NACHTRUHE); CHECK bleibt post-gebunden live. Auf **Facebook** sind **3MINUTEN · RESET · NACHTRUHE LIVE** (eigene Flow-Builder-Flows, „any post", DM „As private reply", deutsche öffentliche Antwort) — die FB-Variante für **7ZEICHEN (Funktionsmodus-Check) baut Katja gerade selbst** (Button-Link `check.katjajung.com`, KEIN Drive-Link). „any post" = Pro-Funktion über ALLE Beiträge → distinktive Keywords (7ZEICHEN/3MINUTEN/RESET/NACHTRUHE), CHECK bleibt post-gebunden. **FB-Gotchas (Memory `project_manychat_facebook_setup`):** FB-DM muss „As private reply" sein; öffentliche FB-Antwort erst nach „Refresh Permissions" (`pages_manage_engagement`) möglich; beim Bearbeiten fällt nach Cmd+A+Tippen oft das erste Zeichen weg (URL-„h" prüfen!). **Noch zu tun:** Katja testet jeden FB-Flow mit Zweit-Account-Kommentar (v. a. crossgepostete Reels).

...
- **Flows (Stand 2026-06-23):**
  ...
  - **Offen für den 28.06. (Pro-Setup):** für RESET + NACHTRUHE den echten Trigger-Reel zuweisen (bisher Platzhalter-Beitrag, weil die Reels noch nicht gepostet sind) → dann **Set Live**; bei allen dreien die öffentliche Kommentar-Antwort von Englisch („Check your inbox, link sent") auf Deutsch umstellen (im Free-Plan nicht editierbar).
